...
export const PROJECTS_DESCRIPTION = [
  {
    ...
    tasksDetails: [
      ...
      },
      {
        ...
        points: [
          'Implemented comprehensive unit tests to verify individual component functionality',
          'Created integration tests to ensure seamless interaction between different website sections',
        ],
      },
    ],
